...
public final class ShamashAsmToolWindowFactory implements ToolWindowFactory, DumbAware {
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ...
        ShamashAsmToolWindowController controller = ShamashAsmToolWindowController.getInstance(project);
