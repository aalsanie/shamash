...
object ProjectLayout {
    ...
    /** Safe, report-only configuration used by configless `shamash scan`. */
    const val DISCOVERY_YML: String = "$BASE/shamash-asm.discovery.yml"

    /** Small production starter configuration generated by `shamash init`. */
    const val STARTER_YML: String = "$BASE/shamash-asm.starter.yml"

    /** Spring-oriented starter selected explicitly with `shamash init --preset spring`. */
