 ...
 *   - maxFields: Int (>= 0)
 */
class MetricsMaxFieldsPerClassSpec : RuleSpec {
    override val key: RuleKey = RuleKey(type = "metrics", name = "maxFieldsPerClass", role = null)
    ...
    override fun validate(
        ...
        try {
            params.requireInt("maxFields", min = 0)
        } catch (e: ParamError) {
            errors +=
                ValidationError(
                    path = e.at,
