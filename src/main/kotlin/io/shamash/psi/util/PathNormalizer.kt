...
/**
 * Normalizes paths for stable, cross-platform reporting/baselining.
 *
 * Goals:
 * - Deterministic separators (always '/')
 * - No drive-letter noise in comparisons
 * - Stable relative-path generation
 */
