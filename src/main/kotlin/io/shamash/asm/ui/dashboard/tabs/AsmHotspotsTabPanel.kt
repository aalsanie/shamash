...
class AsmHotspotsTabPanel(
    ...
    private val header = JBLabel("Run scan to compute hotspots.")
    ...
    private fun recomputeAndRender() {
        ...
        fun controllerSignals(refs: Set<String>): List<String> {
            ...
            val webRefs =
                refs.count {
                    it.contains("/web/") || it.contains("springframework/web") || it.contains("jakarta/servlet") ||
                        it.contains("javax/servlet")
                }
        ...
        val rows =
            when (modeBox.selectedItem as Mode) {
                Mode.GOD -> {
                    classes.values
                        .asSequence()
