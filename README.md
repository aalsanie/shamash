...
A tool to stop JVM architecture drift before it reaches main by scanning compiled Java/Kotlin applications, finds dependency cycles and architecture violations, and can prevent new violations in CI without requiring architecture-test code.
